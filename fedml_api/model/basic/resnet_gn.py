...
__all__ = ['ResNet', 'resnet18_gn', 'resnet34_gn', 'resnet50_gn', 'resnet101_gn',
           'resnet152_gn']
...
def resnet34_gn(pretrained=False, **kwargs):
...
def resnet101_gn(pretrained=False, **kwargs):
...
def resnet152_gn(pretrained=False, **kwargs):
